...
from utils.external_api import get_usage_info
import random
import string
...
def generate_new_code(order_id):
    ...
    # Fetch the simulated usage info from external API
    usage_info = get_usage_info()

    if not usage_info:
        return {"error": "Failed to fetch usage info", "status_code": 500}
